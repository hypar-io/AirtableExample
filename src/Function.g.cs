...
namespace AirtableTest
{
    public class Function
    {
        ...
        private IModelStore<AirtableTestInputs> store;

        public async Task<AirtableTestOutputs> Handler(AirtableTestInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<AirtableTestInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<AirtableTestInputs,AirtableTestOutputs>(store, AirtableTest.Execute);
